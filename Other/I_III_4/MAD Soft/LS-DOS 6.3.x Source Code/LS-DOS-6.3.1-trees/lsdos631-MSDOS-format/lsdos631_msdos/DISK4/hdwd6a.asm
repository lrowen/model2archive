; HDWD1/ASM - Western Digital driver 1000/1010 - 06/10/84
...
R11	EQU	$-2
	JR	Z,EXIT
;
ENDERR	CALL	WD1010		;Reset controller if needed
R12	EQU	$-2
...
POP1	POP	HL
	OR	A		;Set flag
;This is to take care of the WD1010 controller CIP bit
WD1010	PUSH	AF
	IN	A,(STATUS)	;
	AND	00000010B	;Bit 1 is CIP for 1010
	JR	Z,CLEAN		;All OK
	LD	A,10H		;Do a software reset
	OUT	(HDCONT),A
	LD	A,0CH		;Then re-enable
	OUT	(HDCONT),A
CLEAN	POP	AF		;Continue
	RET
;*=*=*
