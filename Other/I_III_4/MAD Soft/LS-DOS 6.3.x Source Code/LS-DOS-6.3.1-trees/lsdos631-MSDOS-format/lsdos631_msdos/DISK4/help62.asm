...
OPREG@	EQU	84H
@@VDCT	MACRO	#BREG,#CREG,#HREG,#LREG,#HLREG
	IFGT	#BREG,0
	LD	B,#BREG
	ENDIF
	IFGT	#CREG,0
...
CLS1	LD	C,1CH
	...
	LD	C,A
	RET
ABORTCH	POP	HL		;steal return address
...
*GET	CLIENT:3
DIRMESS	DB	'   ',16,' HELP [category] [*] [keyword] [(parameter)] ',17,10,10
	DB	'Possible syntax combinations:',10,10
	DB	16,' HELP category ',17,' Displays list of keywords available in category.',10
	DB	16,' HELP category keyword ',17,' Displays information in category about keyword.',10
	DB	16,' HELP *keyword ',17,' Displays information in each available category about keyword.',10,10
	DB	'Parameters are:',10
	DB	'   P - Sends output to printer',10
	DB	'   V - Cancels video restoration',10
	DB	'   R - Cancels reverse video',10
	DB	'   S - Lets you enter a partial keyword name. HELP displays a list of all',10
...
GPROMPT	DB	0AH,'Press <BREAK> to exit or <ENTER> to continue Global Scan',13
